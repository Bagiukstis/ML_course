...
#### PLOTTING ####
plt.scatter(x=c_2_dim[:,0], y=c_2_dim[:,1])  #PCA subspace
plt.scatter(x=class_5_test[:,0], y=class_5_test[:,1], color='green')
plt.scatter(x=class_6_test[:,0], y=class_6_test[:,1], color='red')
plt.scatter(x=class_8_test[:,0], y=class_8_test[:,1], color='yellow')
plt.show()
